...
public class ViaVersionPlayerProperties implements Property {
    ...
    public String getAttribute(Attribute attribute) {
        ...
        if (attribute.startsWith("viaversion")) {
            ...
            int version = api.getPlayerVersion(player.getOfflinePlayer().getUniqueId());
            return new ElementTag(version).getAttribute(attribute.fulfill(1));
        }
