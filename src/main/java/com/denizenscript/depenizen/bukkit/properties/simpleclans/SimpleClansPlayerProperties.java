package com.denizenscript.depenizen.bukkit.properties.simpleclans;
...
public class SimpleClansPlayerProperties implements Property {
    ...
    public static SimpleClansPlayerProperties getFrom(dObject object) {
        if (!describes(object)) {
            return null;
        }
        else {
            return new SimpleClansPlayerProperties((dPlayer) object);
        }
    }
    ...
    private SimpleClansPlayerProperties(dPlayer player) {
        this.player = player;
