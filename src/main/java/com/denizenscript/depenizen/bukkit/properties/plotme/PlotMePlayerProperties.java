...
public class PlotMePlayerProperties implements Property {
    ...
    public static PlotMePlayerProperties getFrom(dObject object) {
        if (!describes(object)) {
            return null;
        }
        else {
            return new PlotMePlayerProperties((dPlayer) object);
        }
    }
    ...
    private PlotMePlayerProperties(dPlayer player) {
        this.player = player;
    }
