...
import com.denizenscript.depenizen.bukkit.properties.heroes.HeroesPlayerNPCProperties;
...
public class HeroesBridge extends Bridge {
    ...
    public void init() {
        ...
        PropertyParser.registerProperty(HeroesPlayerNPCProperties.class, dNPC.class);
        PropertyParser.registerProperty(HeroesPlayerNPCProperties.class, dPlayer.class);
